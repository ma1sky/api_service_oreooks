...
export type usersWhereInput = {
    ...
    tg_id?: Prisma.IntFilter<"users"> | number;
    token?: Prisma.StringFilter<"users"> | string;
};
...
export type usersScalarWhereWithAggregatesInput = {
    ...
    tg_id?: Prisma.IntWithAggregatesFilter<"users"> | number;
    token?: Prisma.StringWithAggregatesFilter<"users"> | string;
};
...
export type usersOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tg_id" | "token", ExtArgs["result"]["users"]>;
...
export interface usersDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     *
     * // Only select the `tg_id`
     * const usersWithTg_idOnly = await prisma.users.findMany({ select: { tg_id: true } })
     *
     */
     ...
     * })
     *
     * // Create many Users and only return the `tg_id`
     * const usersWithTg_idOnly = await prisma.users.createManyAndReturn({
     *   select: { tg_id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     *
     * // Update zero or more Users and only return the `tg_id`
     * const usersWithTg_idOnly = await prisma.users.updateManyAndReturn({
     *   select: { tg_id: true },
     *   where: {
     *     // ... provide filter here
     *   },
...
export interface usersFieldRefs {
    readonly tg_id: Prisma.FieldRef<"users", 'Int'>;
